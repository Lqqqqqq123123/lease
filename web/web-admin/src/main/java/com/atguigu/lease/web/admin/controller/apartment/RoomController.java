...
public class RoomController {
    ...
    public Result saveOrUpdate(@RequestBody RoomSubmitVo roomSubmitVo) {
        boolean res = roomService.customSaveOrUpdate(roomSubmitVo);
    ...
    public Result<IPage<RoomItemVo>> pageItem(@RequestParam long current, @RequestParam long size, RoomQueryVo queryVo) {
        ...
        roomService.customPage(page, queryVo);
    ...
    public Result<RoomDetailVo> getDetailById(@RequestParam Long id) {
        RoomDetailVo vo = roomService.customGetDetailById(id);
        return Result.ok(vo);
    }
    ...
    public Result removeById(@RequestParam Long id) {
        roomService.customRemoveById(id);
        return Result.ok();
    }
    ...
    public Result<List<RoomInfo>> listBasicByApartmentId(Long id) {
        ...
        List<RoomInfo> list = roomService.list(queryWrapper);
